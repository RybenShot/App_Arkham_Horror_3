<p align = "center">
  ...
  <a href= "#pistas">Enlace a la app</a> |
</p>

# Arkham Horror 3 Edicion - Juego de mesa
...
## ¿Por donde vamos?
Ahoramismo el proyecto sigue en fase de desarrollo, estamos en la 4ª version, actualmente ya es completamente funcional, con nuevas cartas incluidas y efectos visuales para los personajes, ayuda a la creacion de losetas de mapa, ayuda para crear el mazo de enemigos para el mapa, voz en off que lee la descripciones demapas e historia de los personajes.
