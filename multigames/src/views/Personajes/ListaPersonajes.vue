    ...
    return {
      ...
      PersonajesBase: [
        ...
        {nombrePJ: "Marie Lambeau",
          ...
          arquetipo1: "Como MÍSTICA, destacas erigiendo salvaguardas arcanas contra el mal. Tu principal ocupación debería ser eliminar fichas de Perdición del tablero. Contribuyes la mejor opción defensiva contra los Primigenios",
        ...
        {nombrePJ: "Jenny Barnes",
          ...
          arquetipo1:"Como EXPERTA, posees un conjunto exclusivo de habilidades que te permite especializarte en una tarea concreta. Jenny no tiene ningún reparo a la hora de solventar sus problemas con Dinero; no dudes en gastarlo cuando te venga bien.",
          ENarquetipo1:"As an EXPERT, you possess an exclusive set of skills that allow you to specialize in a specific task. Jenny has no qualms about solving her problems with Money; don’t hesitate to spend it when it suits you.",
          arquetipo2: null,
          Pertenencia1: {
            urlFoto: "",
          ...
          fotoUrl: require("@/assets/img/Games/AHBase/2imgInvestigadores/PJ3.png"),
        ...
        {nombrePJ: "Dexter Drake",
          ...
          fotoUrl: require("@/assets/img/Games/AHBase/2imgInvestigadores/PJ4.png"),
        ...
        {nombrePJ: "Wendy Adams",
          ...
          arquetipo1:"Como SUPERVIVIENTE, tu ventaja radica en sobrevivir al implacable asalto de los Mitos y ayudar a tus compañeros investigadores a hacer lo mismo. el trabajo en equipo os conducirá a la victoria.",
          ENarquetipo1:"As a SURVIVOR, your advantage lies in surviving the relentless assault of Myths and helping your fellow researchers do the same. Teamwork will lead you to victory.",
          arquetipo2:"Como BUSCADORA, eres una intrépida sabuesa. Deberías concentrarte en la obtención de Pistas y en descubrir su significado oculto. Tu labor es esencial para frustrar los malvados designios de los Primigenios.",
          ENarquetipo2:"As a SEEKER, you are a fearless hound. You should concentrate on getting Clues and discovering their hidden meaning. Your work is essential to thwarting the evil designs of the First Ones.",
          Pertenencia1: {
            urlFoto: "",
        ...
        {nombrePJ: "Rex Murphy",
          ...
          arquetipo1: "Como BUSCADOR, eres un intrépido sabueso. Deberías concentrarte en la obtención de Pistas y en descubrir su significado oculto. Tu labor es esencial para frustrar los malvados designios de los Primigenios.",
          ENarquetipo1: "As a SEEKER, you are a fearless hound. You should concentrate on getting Clues and discovering their hidden meaning. Your work is essential to thwarting the evil designs of the First Ones.",
          arquetipo2: "Como EXPERTO, posees un conjunto exclusivo de habilidades que te permite especializarte en una tarea concreta. Rex ha vivido siempre con su maldición familiar. En consecuencia, has aprendido diversas maneras de paliar tu mala suerte.",
          ENarquetipo2: "As an EXPERT, you possess an exclusive set of skills that allow you to specialize in a specific task. Rex has always lived with his family curse. As a result, you’ve learned several ways to ease your bad luck.",
          Pertenencia1: {
            urlFoto: "",
        ...
        {nombrePJ: "Calvin Wrigth",
          ...
          arquetipo1: "Como DEFENSOR, tu responsabilidad consiste en proteger a tus compañeros investigadores. Esto podría significar ayudarles a recuperarse de daños físicos y mentales, o bien despachar Monstruos antes de que se conviertan en una amenaza.",
          ENarquetipo1: "As an ADVOCATE, your responsibility is to protect your fellow investigators. This could mean helping them recover from physical and mental damage, or dispatching Monsters before they become a threat.",
          arquetipo2: "Como EXPERTO, posees un conjunto exclusivo de habilidades que te permite especializarte en una tarea concreta. A Calvin se le da bien sanar a los demás, aunque esto también puede mantenerte con vida en los momentos más catastróficos.",
          ENarquetipo2: "As an EXPERT, you possess an exclusive set of skills that allow you to specialize in a specific task. Calvin is good at healing others, although this can also keep you alive in the most catastrophic moments.",
          Pertenencia1: {
            urlFoto: "",
        ...
        {nombrePJ: "Agnes Baker",
          ...
          arquetipo1: "Como MÍSTICA, destacas erigiendo salvaguardas arcanas contra el mal. Tu principal ocupación debería ser eliminar fichas de Perdición del tablero. Contribuyes la mejor opción defensiva contra los Primigenios",
          ENarquetipo1: "As a MYSTIC, you stand out by erecting arcane safeguards against evil. Your main occupation should be to remove Doom tiles from the board. You contribute the best defensive option against the Primitives",
          arquetipo2: "Como DEFENSORA, tu responsabilidad consiste en proteger a tus compañeros investigadores. Esto podría significar ayudarles a recuperarse de daños físicos y mentales, o bien despachar Monstruos antes de que se conviertan en una amenaza.",
          ENarquetipo2: "As an DEFENDER, your responsibility is to protect your fellow researchers. This could mean helping them recover from physical and mental damage, or dispatching Monsters before they become a threat.",
          Pertenencia1: {
            urlFoto: "",
        ...
        {nombrePJ: "Michael McGlen",
          ...
          arquetipo1: "Como EXPERTO, posees un conjunto exclusivo de habilidades que te permite especializarte en una tarea concreta. Michael emplea todo su talento para eliminar sin piedad a las grotescas criaturas que amenazan a Arkham.",
          ENarquetipo1: "As an EXPERT, you possess an exclusive set of skills that allow you to specialize in a specific task. Michael uses all his talent to mercilessly eliminate the grotesque creatures that threaten Arkham.",
          arquetipo2: "Como DEFENSOR, tu responsabilidad consiste en proteger a tus compañeros investigadores. Esto podría significar ayudarles a recuperarse de daños físicos y mentales, o bien despachar Monstruos antes de que se conviertan en una amenaza.",
          ENarquetipo2: "As an ADVOCATE, your responsibility is to protect your fellow investigators. This could mean helping them recover from physical and mental damage, or dispatching Monsters before they become a threat.",
          Pertenencia1: {
            urlFoto: "",
        ...
        {nombrePJ: "Daniela Reyes",
          ...
          arquetipo1: "Como EXPERTA, posees un conjunto exclusivo de habilidades que te permite especializarte en una tarea concreta. Daniela es una maestra de la eficacia; sacando el máximo partido de cada acción, podrás alcanzar tus objetivos con facilidad.",
          ENarquetipo1: "As an EXPERT, you possess an exclusive set of skills that allow you to specialize in a specific task. Daniela is a master of efficiency; by making the most of each action, you can easily achieve your goals.",
          arquetipo2: "Como SUPERVIVIENTE, tu ventaja radica en sobrevivir al implacable asalto de los Mitos y ayudar a tus compañeros investigadores a hacer lo mismo. El trabajo en equipo os conducirá a la victoria",
          ENarquetipo2: "As a SURVIVOR, your advantage lies in surviving the relentless assault of Myths and helping your fellow researchers do the same. Teamwork will lead you to victory",
          Pertenencia1: {
            urlFoto: "",
        ...
        {nombrePJ: "Norman Withers",
          ...
          arquetipo1: "Como BUSCADOR, eres un intrépido sabueso. Deberías concentrarte en la obtención de Pistas y en descubrir su significado oculto. Tu labor es esencial para frustrar los malvados designios de los Primigenios.",
          ENarquetipo1: "As a SEEKER, you are a fearless hound. You should concentrate on getting Clues and discovering their hidden meaning. Your work is essential to thwarting the evil designs of the First Ones.",
          arquetipo2: "Como MÍSTICO, destacas erigiendo salvaguardas arcanas contra el mal. Tu principal ocupación debería ser eliminar fichas de Perdición del tablero. Contribuyes la mejor opción defensiva contra los Primigenios.",
          ENarquetipo2: "As a MYSTIC, you stand out by erecting arcane safeguards against evil. Your main occupation should be to remove Doom tiles from the board. You contribute the best defensive option against the Primitives.",
          Pertenencia1: {
            urlFoto: "",
        ...
        {nombrePJ: "Minh Thi Phan",
          ...
          arquetipo1: "Como BUSCADORA, eres un intrépido sabueso. Deberías concentrarte en la obtención de Pistas y en descubrir su significado oculto. Tu labor es esencial para frustrar los malvados designios de los Primigenios.",
          ENarquetipo1: "As a SEEKER, you are a fearless hound. You should concentrate on getting Clues and discovering their hidden meaning. Your work is essential to thwarting the evil designs of the First Ones.",
          arquetipo2: "Como SUPERVIVIENTE, tu ventaja radica en sobrevivir al implacable asalto de los Mitos y ayudar a tus compañeros investigadores a hacer lo mismo. el trabajo en equipo os conducirá a la victoria.",
          ENarquetipo2: "As a SURVIVOR, your advantage lies in surviving the relentless assault of Myths and helping your fellow researchers do the same. Teamwork will lead you to victory.",
          Pertenencia1: {
      ...
      PersonajesMareasTenebrosas: [
        ...
        arquetipo1: "Como SUPERVIVIENTE, tu ventaja radica en sobrevivir al implacable asalto de los Mitos y ayudar a tus compañeros investigadores a hacer lo mismo. El trabajo en equipo os conducirá a la victoria.",
        ENarquetipo1: "As a SURVIVOR, your advantage lies in surviving the relentless assault of Myths and helping your fellow researchers do the same. Teamwork will lead you to victory.",
        arquetipo2: "Como EXPERTO, posees un conjunto exclusivo de habilidades que te permite especializarte en una tarea concreta. El linaje de Silas comparte un siniestro lazo de parentesco con ciertas criaturas de los Mitos, lo cual te confiere la insólita capacidad de predecir y controlar los movimientos de los Monstruos que os amenazan.",
        ENarquetipo2: "As an EXPERT, you possess an exclusive set of skills that allow you to specialize in a specific task. Silas' lineage shares a sinister kinship with certain creatures of the Mythos, which gives you the unusual ability to predict and control the movements of the Monsters that threaten you.",
        Pertenencia1:{
            urlFoto: "",
            nombre: "Red de pesca",
          ...
          fotoUrl: require("@/assets/img/Games/AHMareasTenebrosas/2imgInvestigadores/PJ13.jpg"),
          expansion: null
        },
        ...
        arquetipo1: "Como EXPERTO, posees un conjunto exclusivo de habilidades que te permite especializarte en una tarea concreta. Charlie tiene don de gentes. Puedes valerte de su labia para sortear la mayoría de los obstáculos, y siempre dispones de una ayudante solícita.",
        ENarquetipo1: "As an EXPERT, you have an exclusive set of skills that allow you to specialize in a specific task. Charlie has a talent for people. You can use his speech to overcome most obstacles, and you always have a helpful assistant.",
        arquetipo2: "Como BUSCADOR , eres un intrépido sabueso. Deberías concentrarte en la obtención de Pistas y en descubrir su significado. Tu labor es esencial para frustrar los malvados designios de los Primigenios.",
        ENarquetipo2: "As a SEEKER, you are a fearless hound. You should concentrate on getting Clues and discovering their meaning. Your work is essential to thwarting the evil designs of the First Ones.",
        Pertenencia1:{
            urlFoto: "",
        ...
        fotoUrl: require("@/assets/img/Games/AHMareasTenebrosas/2imgInvestigadores/PJ14.jpg"),
        },
        ...
        Pertenencia4: {
          ...
          fotoUrl: require("@/assets/img/Games/AHMareasTenebrosas/2imgInvestigadores/PJ15.jpg"),
        },
        ...
        arquetipo1: "Como DEFENSORA, tu responsabilidad consiste en proteger a tus compañeros investigadores. Esto podría significar ayudarlos a recuperarse de daños físicos o mentales, o bien despachar Monstruos antes de que se conviertan en una amenaza.",
        ENarquetipo1: "As an DEFENDER, your responsibility is to protect your fellow researchers. This could mean helping them recover from physical or mental damage, or dispatching Monsters before they become a threat.",
        arquetipo2: "Como MÍSTICA, destacas erigiendo salvaguardas arcanas contra el mal. Tu principal ocupación debería ser eliminar fichas de Perdición del tablero. Constituyes la mejor opción defensiva contra los Primigenios.",
        ENarquetipo2: "As a MYSTIC, you stand out by erecting arcane safeguards against evil. Your main occupation should be to remove Doom tiles from the board. You are the best defensive option against the Primitives.",
        Pertenencia1:{
          urlFoto: "",
        ...
        Pertenencia4: {
          ...
          fotoUrl: require("@/assets/img/Games/AHMareasTenebrosas/2imgInvestigadores/PJ16.jpg"),
        },
        {nombrePJ: "Padre Mateo",
          ...
          ENarquetipo1: "As a MYSTIC, you stand out by erecting arcane safeguards against evil. Your main occupation should be to remove Doom tiles from the board. You contribute the best defensive option against the Primitives",
          arquetipo2: "Como DEFENSOR, tu responsabilidad consiste en proteger a tus compañeros investigadores. Esto podría significar ayudarles a recuperarse de daños físicos y mentales, o bien despachar Monstruos antes de que se conviertan en una amenaza.",
          ENarquetipo2: "As an DEFENDER, your responsibility is to protect your fellow investigators. This could mean helping them recover from physical and mental damage, or dispatching Monsters before they become a threat.",
          Pertenencia1:{
            urlFoto: "",
          ...
          fotoUrl: require("@/assets/img/Games/AHMareasTenebrosas/2imgInvestigadores/PJ17.jpg"),
        },
        {nombrePJ: "Patricie Hathaway",
          ...
          fotoUrl: require("@/assets/img/Games/AHMareasTenebrosas/2imgInvestigadores/PJ18.jpg"),
        },
        {nombrePJ: "Carson Sinclair",
          ...
          arquetipo1: "Como BUSCADOR , eres un intrépido sabueso. Deberías concentrarte en obtención de Pistas y en descubrir su significado. Tu labor es esencial para frustrar los malvados designios de los Primigenios.",
          ENarquetipo1: "As a SEEKER, you are a fearless hound. You should concentrate on getting clues and discovering their meaning. Your work is essential to thwarting the evil designs of the First Ones.",
          arquetipo2: "Como SUPERVIVIENTE, tu ventaja radica en sobrevivir al implacable asalto de los Mitos y ayudar a tus compañeros investigadores a hacer lo mismo. El trabajo en equipo os conducirá a la victoria.",
          ENarquetipo2: "As a SURVIVOR, your advantage lies in surviving the relentless assault of Myths and helping your fellow researchers do the same. Teamwork will lead you to victory.",
          Pertenencia1:{
            urlFoto: "",
          ...
          fotoUrl: require("@/assets/img/Games/AHMareasTenebrosas/2imgInvestigadores/PJ19.jpg"),
        },
        {nombrePJ: "Pete Cubo de Basura",
          ...
          fotoUrl: require("@/assets/img/Games/AHMareasTenebrosas/2imgInvestigadores/PJ20.jpg"),
        },
      ],
      PersonajesOriginal:[
        {nombrePJ: "Darrell Simmons",
          ...
          fotoUrl: require("@/assets/img/Games/AHOriginal/2imgInvestigadores/PJ21.jpg"),
        ...
        {nombrePJ: "Gloria Goldberg",
          ...
          HistoriaYT: "A3eG_3SDUTA" ,
          fotoUrl: require("@/assets/img/Games/AHOriginal/2imgInvestigadores/PJ22.jpg"),
          expansion: "Original - SegundaEd."
        },
        {nombrePJ: "Mandy Thompson",
          ...
          fotoUrl: require("@/assets/img/Games/AHOriginal/2imgInvestigadores/PJ23.jpg"),
          expansion: "Original - SegundaEd."
        },
        {nombrePJ: "Montarrey Jack",
          ...
          fotoUrl: require("@/assets/img/Games/AHOriginal/2imgInvestigadores/PJ24.jpg"),
          expansion: "Original - SegundaEd."
        },
      ],
