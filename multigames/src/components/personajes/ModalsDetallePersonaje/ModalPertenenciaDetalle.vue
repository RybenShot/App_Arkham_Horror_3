          ...
          <div class="modal-card">
            ...
            <section class="modal-card-body hero is-large pt-2 pb-6">
              ...
              <div class="columns is-mobile">
                <img :class="{'column': this.$store.state.datosPJactual.Pertenencia2 }" class="CartasPertenencias cajaCartas" :src="this.$store.state.datosPJactual.Pertenencia1.fotoCartaPertenenciaURL" alt="">
